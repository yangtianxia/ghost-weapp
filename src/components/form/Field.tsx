...
import { FIELD_INJECTION_KEY } from '../_utils/field-value'
...
export const fieldSharedProps = {
  ...
  leftIcon: String as PropType<IconTypes>,
  leftIconSize: numericProp,
  ...
  clearIcon: makeStringProp<IconTypes>('clear'),
